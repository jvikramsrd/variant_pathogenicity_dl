...
| sequence_similarity | warning | 0 | fold MLH1: training proteins >= 20% identical to the held-out protein: {'P40692-P54278': 0.259}; 0 test variants have a labelled training variant at the aligned paralog residue (0 with the same substitution) |
| sequence_similarity | warning | 0 | fold MSH2: training proteins >= 20% identical to the held-out protein: {'P43246-P52701': 0.263}; 0 test variants have a labelled training variant at the aligned paralog residue (0 with the same substitution) |
| sequence_similarity | warning | 0 | fold MSH6: training proteins >= 20% identical to the held-out protein: {'P43246-P52701': 0.263}; 0 test variants have a labelled training variant at the aligned paralog residue (0 with the same substitution) |
| sequence_similarity | warning | 0 | fold PMS2: training proteins >= 20% identical to the held-out protein: {'P40692-P54278': 0.259}; 0 test variants have a labelled training variant at the aligned paralog residue (0 with the same substitution) |
