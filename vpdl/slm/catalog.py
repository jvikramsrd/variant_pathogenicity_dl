...
SOURCES: tuple[Source, ...] = (
    ...
    S("pmc_oa_comm", "PMC Open Access (commercial-use subset)", "literature", ("PRETRAINING",),
      "per article: CC0 / CC BY / CC BY-SA / CC BY-ND", "https://ftp.ncbi.nlm.nih.gov/pub/pmc/",
      "not_downloaded", "full-text articles", leakage_risk="medium"),
    ...
    S("medlineplus_genetics", "MedlinePlus Genetics", "literature", ("PRETRAINING", "KNOWLEDGE_BASE"),
      ...
      "plain-language gene and condition summaries"),
    ...
    S("mondo", "Mondo disease ontology", "phenotype", ("REFERENCE_ONLY",), "CC BY 4.0",
      "OBO download", "not_downloaded", "disease identifiers and hierarchy",
    ...
    S("orphanet", "Orphanet / Orphadata", "phenotype", ("KNOWLEDGE_BASE",), "CC BY 4.0",
      "XML/JSON", "not_downloaded", "rare-disease definitions and genes"),
